...
const processDiff = <TModel extends prismic.CustomTypeModel | prismic.SharedSliceModel>(
	before: TModel[],
	after: TModel[],
	callbacks: {
...
/** Create a bulk update transaction instance to pass to a Custom Types Client `bulkUpdate()` method. */
